...
cp -prv ./release/3.0.5.1/code.photoswipe-3.0.5.1.min.js 	/projects/autotrack/public/scripts/at/code.photoswipe.js
cp -prv ./release/3.0.5.1/code.photoswipe-3.0.5.1.js 		/projects/autotrack/public/scripts-src/at/code.photoswipe.js
